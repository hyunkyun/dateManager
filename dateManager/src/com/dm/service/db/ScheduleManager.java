...
public class ScheduleManager{
		...
		private static final String CLASSNAME = ScheduleManager.class.getSimpleName();
		private DBHelper db;
		...
		public void insert(final Schedule to){
		...
		public void update(final Schedule to){
			ContentValues values = new ContentValues();
			values.put(ScheduleTable.ID, to.getId());
			values.put(ScheduleTable.TITLE, to.getTitle());
			values.put(ScheduleTable.START_TIME, to.getStart_time());
			...
			Log.v(TAG, ScheduleManager.CLASSNAME + " update id:" + to.getId() + ", name:" +  to.getTitle());
			db.update(ScheduleTable.TABLE_NAME, values, to.getId());
		}
		
		public void delete(final int id){
			Log.v(TAG, ScheduleManager.CLASSNAME + " delete id:" + id );
		...
		public List<Schedule> get(){
			...
			try{
				Log.v(TAG, ScheduleManager.CLASSNAME + " getList ");
				c = db.get(sql);
				ret = setBindCursor(c);
				
			}catch(SQLException e){
				Log.e(TAG, ScheduleManager.CLASSNAME + " getList sqlerror");
			}finally{
		...
		public ArrayList<Schedule> setBindCursor(final Cursor c){
		...
		public void logListInfo(List<Schedule> to){
